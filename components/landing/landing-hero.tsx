    ...
    <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {[
            // Every figure here must be one we can substantiate on request.
            // Previously: "150+ Signal Sources" (16 are wired), "99.9% Uptime SLA"
            // (no uptime monitoring exists) and "SOC 2 Compliant" (no audit).
            { value: "16", label: "Intelligence Sources" },
            { value: "8", label: "Risk Dimensions" },
            { value: "SOC 2", label: "Framework Mapping" },
            { value: "NIST CSF", label: "Aligned" },
          ].map((stat) => (
